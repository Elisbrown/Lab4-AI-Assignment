...
clusterer = hdbscan.HDBSCAN(min_cluster_size=5, metric='euclidean', algorithm='best')
...
for metric in metrics:
    temp_clusterer = hdbscan.HDBSCAN(min_cluster_size=5, metric=metric, algorithm='generic')
...
new_label = clusterer.fit_predict(new_image_pca)
print(f"New image assigned to cluster: {new_label[0]}")
